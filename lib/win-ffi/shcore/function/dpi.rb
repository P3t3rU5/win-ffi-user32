...
require 'win-ffi/typedef/hmonitor'
...
require 'win-ffi/shcore/enum/shell_ui_component'
  ...
  module Shcore
    ...
    if WINDOWS_VERSION >= 8
      ...
      if WINDOWS_VERSION >= 8.1
        ...
        #   _Out_ UINT             *dpiX,
        #   _Out_ UINT             *dpiY)
        attach_function 'GetDpiForMonitor', [WinFFI.find_type(:hmonitor), MonitorDpiType, :pointer, :pointer], :hresult
        ...
        attach_function 'GetScaleFactorForMonitor', [WinFFI.find_type(:hmonitor), :pointer], :stdapi
