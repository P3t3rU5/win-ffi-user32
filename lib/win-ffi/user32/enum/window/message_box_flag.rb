...
module WinFFI
   module User32
      MessageBoxFlag = enum :message_box_flag, [
         ...
         # Icons -----------------------
         :ICONERROR,       0x00000010, # A stop-sign icon
         :ICONHAND,        0x00000010, # Same as above
         :ICONSTOP,        0x00000010, # Same as above
         :ICONQUESTION,    0x00000020, # A question-mark icon. Not Recomended
         :ICONWARNING,     0x00000030, # An exclamation-point icon
         :ICONEXCLAMATION, 0x00000030, # Same as above
         :ICONASTERISK,    0x00000040, # Lowercase letter i in a circle
         :ICONINFORMATION, 0x00000040, # Same as above
         :USERICON,        0x00000080,
