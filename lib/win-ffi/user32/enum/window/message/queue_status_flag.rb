    ...
    if WINDOWS_VERSION >= :xp
      ...
      if WINDOWS_VERSION >= 8
        buffer += [
            ...
            :ALLINPUT,  0x1CFF, # :INPUT | :POSTMESSAGE | :TIMER | :PAINT | :HOTKEY | :SENDMESSAGE, Any message is in
            # the queue.
        ]
      else
        buffer += [
            ...
            # WM_HOTKEY, or posted message is in the queue.
            :ALLINPUT,  0x04FF, # :INPUT | :POSTMESSAGE | :TIMER | :PAINT | :HOTKEY | :SENDMESSAGE, Any message is in
            # the queue.
        ]
      end
    else
