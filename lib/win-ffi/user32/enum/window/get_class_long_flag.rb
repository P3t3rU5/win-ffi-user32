...
module WinFFI
  module User32
    ...
    GetClassLongFlag = enum :get_class_long_flag, [
        ...
        :CBWNDEXTRA,    -18, #Sets the size, in bytes, of the extra window_class memory associated with each
        # window_class in the class. Setting this value does not change the number of extra bytes already allocated. For
