...
module WinFFI
  module User32
    ...
    AnimateWindowFlag = enum :animate_window_flag, [
        :HOR_POSITIVE, 0x00000001, # Animates the window_class from left to right. This flag can be used with roll or
        # slide animation. It is ignored when used with AW_CENTER or AW_BLEND.

        :HOR_NEGATIVE, 0x00000002, # Animates the window_class from right to left. This flag can be used with roll or
        # slide animation. It is ignored when used with AW_CENTER or AW_BLEND.

        :VER_POSITIVE, 0x00000004, # Animates the window_class from top to bottom. This flag can be used with roll or
        # slide animation. It is ignored when used with AW_CENTER or AW_BLEND.

        :VER_NEGATIVE, 0x00000008, # Animates the window_class from bottom to top. This flag can be used with roll or
        # slide animation. It is ignored when used with AW_CENTER or AW_BLEND.

        :CENTER, 0x00000010, # Makes the window_class appear to collapse inward if AW_HIDE is used or expand outward if
