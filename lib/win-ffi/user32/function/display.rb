...
require 'win-ffi/gdi32/enum/display_config/topology_id'
require 'win-ffi/gdi32/enum/set_display_config_flag'
require 'win-ffi/gdi32/enum/query_display_config_flag'

require 'win-ffi/gdi32/struct/display_config/device_info_header'
require 'win-ffi/gdi32/struct/display_config/mode_info'
require 'win-ffi/gdi32/struct/display_config/path_info'
