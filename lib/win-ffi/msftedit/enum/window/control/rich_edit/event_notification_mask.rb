...
module WinFFI
  if WINDOWS_VERSION >= 8
    module Msftedit
      ...
      # https://msdn.microsoft.com/en-us/library/windows/desktop/bb774366(v=vs.85).aspx
      EventNotificationMask = enum :event_notification_mask, [
          :NONE,              0x00000000,
          :CHANGE,            0x00000001,
          :UPDATE,            0x00000002,
          :SCROLL,            0x00000004,
          ...
          :HIDELINKTOOLTIP,   0x80000000,
      ]

      define_prefix(:ENM, EventNotificationMask)
    end
  end
end